...
const JobDetail = (): React.JSX.Element => {
  ...
  return (
    <div className="max-w-3xl mx-auto my-6 rounded-2xl overflow-hidden shadow-lg border border-gray-200">
      <div className="bg-gradient-to-r from-purple-700 to-fuchsia-600 p-6 text-white flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex justify-between">
            ...
            <span className="bg-green-200 text-green-800 px-3 py-1 rounded-full font-medium text-sm flex items-center">
      ...
      <div className="p-6 bg-white flex flex-col gap-6 sm:flex-row sm:justify-between sm:items-start">
        ...
        <div className="flex flex-col gap-2 w-full sm:w-60 mt-6 sm:mt-0">
          ...
          <button className="flex items-center justify-center gap-2 w-full bg-blue-700 hover:bg-blue-800 text-white py-3 rounded-lg transition-all my-2">
            <FaPlus /> Apply Now
          </button>
          <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-2 rounded-lg transition-all my-2">
            Back to Jobs
          </button>
        </div>
      </div>
